...
Continue through the published parts:

- [Part II, Chapters 5–10](./ch-05/): build the mathematical and programming foundations, then compare sparse and neural baselines. Read the [Python primer](./primer-py/) after the core of Chapter 5.
- [Part III, Chapters 11–14](./ch-11/): follow sequence memory, recurrent models and attention.
- [Part IV, Chapters 15–21](./ch-15/): work through a Transformer and build, train and examine a Mini GPT.
